...
#define GEN_STRING(name, value, sclass, scateg, slevel, al_read, al_write,  \
  ...
  {name,                                                                    \
   ...
   INIT_BRACE_BEGIN.string = {value, _default, sizeof(value),               \
                              func_validate, strdup("")} INIT_BRACE_END,    \
   func_action,                                                             \
   FALSE},
...
#define GEN_ENUM(name, value, sclass, scateg, slevel, al_read, al_write,    \
  ...
  {name,                                                                    \
   ...
   scateg,                                                                  \
   slevel,                                                                  \
   INIT_BRACE_BEGIN.enumerator = {&value, sizeof(value), _default,          \
                                  func_validate,                            \
...
static struct setting settings[] = {
    ...
    GEN_ENUM(
        ...
        NULL, mapsize_callback, NULL, mapsize_name, MAP_DEFAULT_MAPSIZE)

        GEN_INT(
            "size", wld.map.server.size, SSET_MAP_SIZE, SSET_GEOLOGY,
            ...
            N_("This value is used to determine the map area.\n"
               ...
               "(FULLSIZE)."),
            NULL, NULL, NULL, MAP_MIN_SIZE, MAP_MAX_SIZE, MAP_DEFAULT_SIZE)

            GEN_INT(
                "tilesperplayer", wld.map.server.tilesperplayer,
                SSET_MAP_SIZE, SSET_GEOLOGY, SSET_VITAL, ALLOW_NONE,
                ALLOW_BASIC, N_("Number of (land) tiles per player"),
                /* TRANS: The strings between double quotes are also
                 * translated separately (they must match!). The strings
                 * between single quotes are setting names and shouldn't be
                 * translated. The strings between parentheses and in
                 * uppercase must stay as untranslated. */
                N_("This value is used to determine the map dimensions. It "
                   "calculates the map size at game start based on the "
                   "number "
                   "of players and the value of the setting 'landmass'.\n"
                   "For this option to take effect, the \"Map size "
                   "definition\" "
                ...
                GEN_INT(
                    "xsize", wld.map.xsize, SSET_MAP_SIZE, SSET_GEOLOGY,
                    SSET_VITAL, ALLOW_NONE, ALLOW_BASIC,
                    N_("Map width in tiles"),
                    /* TRANS: The strings between double quotes are also
                     * translated separately (they must match!). The strings
                     * between single quotes are setting names and shouldn't
                     * be translated. The strings between parentheses and in
                     * uppercase must stay as untranslated. */
                    N_("Defines the map width.\n"
                       "For this option to take effect, the \"Map size "
                       "definition\" "
                       "option ('mapsize') must be set to \"Width and "
                       "height\" "
                       "(XYSIZE)."),
                    NULL, xsize_callback, NULL, MAP_MIN_LINEAR_SIZE,
                    MAP_MAX_LINEAR_SIZE, MAP_DEFAULT_LINEAR_SIZE)
                    GEN_INT("ysize", wld.map.ysize, SSET_MAP_SIZE,
                            SSET_GEOLOGY, SSET_VITAL, ALLOW_NONE,
                            ALLOW_BASIC, N_("Map height in tiles"),
                            /* TRANS: The strings between double quotes are
                             * also translated separately (they must match!).
                             * The strings between single quotes are setting
                             * names and shouldn't be translated. The strings
                             * between parentheses and in uppercase must stay
                             * as untranslated. */
                            N_("Defines the map height.\n"
                               "For this option to take effect, the \"Map "
                               "size definition\" "
                               "option ('mapsize') must be set to \"Width "
                               "and height\" "
                               "(XYSIZE)."),
                            NULL, ysize_callback, NULL, MAP_MIN_LINEAR_SIZE,
                            MAP_MAX_LINEAR_SIZE, MAP_DEFAULT_LINEAR_SIZE)

                        GEN_BITWISE("topology", wld.map.topology_id,
                                    ...
                                    N_("Freeciv maps are always "
                                       "two-dimensional. They may wrap at "
                                       "the north-south and east-west "
                                       "directions to form a flat "
                                       "map, a cylinder, or a torus "
                                       "(donut). Individual tiles may "
                                       "be rectangular or hexagonal, with "
                                       "either an overhead "
                                       "(\"classic\") or isometric "
                                       "alignment.\n"
                            ...
                            GEN_ENUM(
                                "generator", wld.map.server.generator,
                                SSET_MAP_GEN, SSET_GEOLOGY, SSET_VITAL,
                                ALLOW_NONE, ALLOW_BASIC,
                                N_("Method used to generate map"),
                                /* TRANS: The strings between double quotes
                                 * are also translated separately (they must
                                 * match!). The strings between single quotes
                                 * (except 'fair') are setting names and
                                 * shouldn't be translated. The strings
                                 * between parentheses and in uppercase
                                 * must stay as untranslated. */
                                N_("Specifies the algorithm used to "
                                   "generate the map. If the "
                                   "default value of the 'startpos' option "
                                   "is used, then the "
                                   "chosen generator chooses an appropriate "
                                   "'startpos' setting; "
                                   "otherwise, the generated map tries to "
                                   "accommodate the "
                                   "chosen 'startpos' setting.\n"
                                   "- \"Scenario map\" (SCENARIO): "
                                   "indicates a pre-generated map. "
                                   "By default, if the scenario does not "
                                   "specify start positions, "
                                   "they will be allocated depending on the "
                                   "size of continents.\n"
                                   "- \"Fully random height\" (RANDOM): "
                                   "generates maps with a "
                                   "number of equally spaced, relatively "
                                   "small islands. By default, "
                                   "start positions are allocated depending "
                                   "on continent size.\n"
                                   "- \"Pseudo-fractal height\" (FRACTAL): "
                                   "generates Earthlike "
                                   "worlds with one or more large "
                                   "continents and a scattering of "
                                   "smaller islands. By default, players "
                                   "are all placed on a "
                                   "single continent.\n"
                                   "- \"Island-based\" (ISLAND): generates "
                                   "'fair' maps with a "
                                   "number of similarly-sized and -shaped "
                                   "islands, each with "
                                   "approximately the same ratios of "
                                   "terrain types. By default, "
                                   "each player gets their own island.\n"
                                   "- \"Fair islands\" (FAIR): generates "
                                   "the exact copy of the "
                                   "same island for every player or every "
                                   "team.\n"
                                   "- \"Fracture map\" (FRACTURE): "
                                   "generates maps from a fracture "
                                   "pattern. Tends to place hills and "
                                   "mountains along the edges "
                                   "of the continents.\n"
                                   "If the requested generator is "
                                   "incompatible with other server "
                                   "settings, the server may fall back to "
                                   "another generator."),
                                NULL, generator_validate, NULL,
                                generator_name, MAP_DEFAULT_GENERATOR)

                                GEN_ENUM(
                                    "startpos", wld.map.server.startpos,
                                    SSET_MAP_GEN, SSET_GEOLOGY, SSET_VITAL,
                                    ALLOW_NONE, ALLOW_BASIC,
                                    N_("Method used to choose start "
                                       "positions"),
                                    /* TRANS: The strings between double
                                     * quotes are also translated separately
                                     * (they must match!). The strings
                                     * between single quotes (except 'best')
                                     * are setting names and shouldn't be
                                     * translated. The strings between
                                     * parentheses and in uppercase
                                     * must stay as untranslated. */
                                    N_("The method used to choose where "
                                       "each player's initial units "
                                       "start on the map. (For scenarios "
                                       "which include pre-set "
                                       "start positions, this setting is "
                                       "ignored.)\n"
                                       "- \"Generator's choice\" (DEFAULT): "
                                       "the start position "
                                       "placement will depend on the map "
                                       "generator chosen. See the "
                                       "'generator' setting.\n"
                                       "- \"One player per continent\" "
                                       "(SINGLE): one player is "
                                       "placed on each of a set of "
                                       "continents of approximately "
                                       "equivalent value (if possible).\n"
                                       "- \"Two or three players per "
                                       "continent\" (2or3): similar "
                                       "to SINGLE except that two players "
                                       "will be placed on each "
                                       "continent, with three on the 'best' "
                                       "continent if there is an "
                                       "odd number of players.\n"
                                       "- \"All players on a single "
                                       "continent\" (ALL): all players "
                                       "will start on the 'best' available "
                                       "continent.\n"
                                       "- \"Depending on size of "
                                       "continents\" (VARIABLE): players "
                                       "will be placed on the 'best' "
                                       "available continents such that, "
                                       "as far as possible, the number of "
                                       "players on each continent "
                                       "is proportional to its value.\n"
                                       "If the server cannot satisfy the "
                                       "requested setting due to "
                                       "there being too many players for "
                                       "continents, it may fall "
                                       "back to one of the others. "
                                       "(However, map generators try to "
                                       "create the right number of "
                                       "continents for the choice of this "
                                       "'startpos' setting and the number "
                                       "of players, so this is "
                                       "unlikely to occur.)"),
                                    NULL, NULL, NULL, startpos_name,
                                    MAP_DEFAULT_STARTPOS)

                                    GEN_ENUM(
                                        "teamplacement",
                                        wld.map.server.team_placement,
                                        SSET_MAP_GEN, SSET_GEOLOGY,
                                        SSET_VITAL, ALLOW_NONE, ALLOW_BASIC,
                                        N_("Method used for placement of "
                                           "team mates"),
                                        /* TRANS: The strings between double
                                         * quotes are also translated
                                         * separately (they must match!). The
                                         * strings between single quotes are
                                         * setting names and shouldn't be
                                         * translated. The strings between
                                         * parentheses and in uppercase must
                                         * stay as untranslated. */
                                        N_("After start positions have been "
                                           "generated thanks to the "
                                           "'startpos' setting, this "
                                           "setting controls how the start "
                                           "positions will be assigned to "
                                           "the different players of the "
                                           "same team.\n"
                                           "- \"Disabled\" (DISABLED): the "
                                           "start positions will be "
                                           "randomly assigned to players, "
                                           "regardless of teams.\n"
                                           "- \"As close as possible\" "
                                           "(CLOSEST): players will be "
                                           "placed as close as possible, "
                                           "regardless of continents.\n"
                                           "- \"On the same continent\" "
                                           "(CONTINENT): if possible, place "
                                           "all players of the same team "
                                           "onto the same "
                                           "island/continent.\n"
                                           "- \"Horizontal placement\" "
                                           "(HORIZONTAL): players of the "
                                           "same "
                                           "team will be placed "
                                           "horizontally.\n"
                                           "- \"Vertical placement\" "
                                           "(VERTICAL): players of the same "
                                           "team will be placed "
                                           "vertically."),
                                        NULL, NULL, NULL, teamplacement_name,
                                        ...
                                        GEN_BOOL(
                                            ...
                                            SSET_MAP_GEN, SSET_GEOLOGY,
                                            SSET_RARE, ALLOW_NONE,
                                            ALLOW_BASIC,
                                            N_("Presence of 1x1 islands"),
                                            N_("This setting controls "
                                               "whether the map generator "
                                               "is allowed "
                                               "to make islands of one only "
                                               "tile size."),
                                            NULL, NULL,
                                            ...
                                            GEN_BOOL(
                                                ...
                                                SSET_MAP_GEN, SSET_GEOLOGY,
                                                SSET_SITUATIONAL, ALLOW_NONE,
                                                ALLOW_BASIC,
                                                N_("Whether the poles are "
                                                   "separate continents"),
                                                N_("If this setting is "
                                                   "disabled, the "
                                                   "continents may attach "
                                                   "to "
                                                   "poles."),
                                                NULL, NULL,
                                                ...
                                                GEN_INT(
                                                    "flatpoles",
                                                    wld.map.server.flatpoles,
                                                    SSET_MAP_GEN,
                                                    SSET_GEOLOGY,
                                                    SSET_SITUATIONAL,
                                                    ALLOW_NONE, ALLOW_BASIC,
                                                    N_("How much the land "
                                                       "at the poles is "
                                                       "flattened"),
                                                    /* TRANS: The strings in
                                                       quotes shouldn't be
                                                       translated. */
                                                    N_("Controls how much "
                                                       "the height of the "
                                                       "poles is flattened "
                                                       "during map "
                                                       "generation, "
                                                                        ...
                                                                        GEN_INT("wetness",
                                                                            ...
                                                                            GEN_BOOL(
                                                                                ...
                                                                                GEN_INT("globalwarming_percent",
                                                                                    ...
                                                                                    GEN_BOOL("nuclearwinter",
                                                                                             game.info
                                                                                                 .nuclear_winter,
                                                                                             SSET_RULES, SSET_GEOLOGY, SSET_VITAL, ALLOW_NONE,
                                                                                             ALLOW_BASIC,
                                                                                             N_("Nuclear winter"),
    ...
    GEN_INT("gameseed", game.server.seed_setting, SSET_MAP_ADD,
        ...
        GEN_INT("specials", wld.map.server.riches, SSET_MAP_ADD,
                ...
                N_("Special resources improve the basic terrain type they "
                   ...
                   "thousand."),
                NULL, NULL, NULL, MAP_MIN_RICHES, MAP_MAX_RICHES,
                MAP_DEFAULT_RICHES)

            GEN_INT("huts", wld.map.server.huts, SSET_MAP_ADD, SSET_GEOLOGY,
                    SSET_VITAL, ALLOW_NONE, ALLOW_BASIC,
                    N_("Amount of huts (bonus extras)"),
                    N_("Huts are tile extras that usually may be "
                       "investigated by "
                       "units."
                       "The server variable's scale is huts per thousand "
                       "tiles."),
                    huts_help, NULL, huts_action, MAP_MIN_HUTS, MAP_MAX_HUTS,
                    MAP_DEFAULT_HUTS)

                GEN_INT("animals", wld.map.server.animals, SSET_MAP_ADD,
                        SSET_GEOLOGY, SSET_VITAL, ALLOW_NONE, ALLOW_BASIC,
                        N_("Amount of animals"),
                        N_("Number of animals initially created on terrains "
                           "defined for them in the ruleset (if the ruleset "
                           "supports it). "
                           "The server variable's scale is animals per "
                           "thousand tiles."),
                        NULL, NULL, NULL, MAP_MIN_ANIMALS, MAP_MAX_ANIMALS,
                        MAP_DEFAULT_ANIMALS)
    ...
    GEN_INT("minplayers", game.server.min_players, SSET_PLAYERS,
            ...
            NULL, NULL, NULL, GAME_MIN_MIN_PLAYERS, GAME_MAX_MIN_PLAYERS,
            GAME_DEFAULT_MIN_PLAYERS)

        GEN_INT(
            "maxplayers", game.server.max_players, SSET_PLAYERS,
            SSET_INTERNAL, SSET_VITAL, ALLOW_NONE, ALLOW_BASIC,
            ...
            N_("The maximal number of human and AI players who can be in "
               ...
               "will be rejected.\n"
               "When playing a scenario which defines player start "
               "positions, "
               "this setting cannot be set to greater than the number of "
               "defined start positions."),
            NULL, maxplayers_callback, NULL, GAME_MIN_MAX_PLAYERS,
            GAME_MAX_MAX_PLAYERS, GAME_DEFAULT_MAX_PLAYERS)

            GEN_INT(
                "aifill", game.info.aifill, SSET_PLAYERS, SSET_INTERNAL,
                SSET_VITAL, ALLOW_NONE, ALLOW_BASIC,
                ...
                NULL, NULL, aifill_action, GAME_MIN_AIFILL, GAME_MAX_AIFILL,
                GAME_DEFAULT_AIFILL)

                GEN_ENUM(
                    "persistentready", game.info.persistent_ready, SSET_META,
                    SSET_NETWORK, SSET_RARE, ALLOW_NONE, ALLOW_BASIC,
                    N_("When the Readiness of a player gets autotoggled "
                       "off"),
                    N_("In pre-game, usually when new players join or old "
                       "ones leave, "
                       "those who have already accepted game to start by "
                       "toggling \"Ready\" "
                       "get that autotoggled off in the changed situation. "
                       "This setting "
                       "can be used to make readiness more persistent."),
                    NULL, NULL, NULL, persistentready_name,
                    GAME_DEFAULT_PERSISTENTREADY)

                    GEN_STRING(
                        "nationset", game.server.nationset, SSET_PLAYERS,
                        SSET_INTERNAL, SSET_RARE, ALLOW_NONE, ALLOW_BASIC,
                        N_("Set of nations to choose from"),
                        /* TRANS: do not translate '/list nationsets' */
                        N_("Controls the set of nations allowed in the "
                           "game. The "
                           "choices are defined by the ruleset.\n"
                           "Only nations in the set selected here will be "
                           "allowed in "
                           "any circumstances, including new players and "
                           "civil war; "
                           "small sets may thus limit the number of players "
                           "in a game.\n"
                           "If this is left blank, the ruleset's default "
                           "nation set is "
                           "used.\n"
                           "See '/list nationsets' for possible choices for "
                           "the "
                           "currently loaded ruleset."),
                        nationset_callback, nationset_action,
                        ...
                        GEN_INT("ec_turns", game.server.event_cache.turns,
                                ...
                                N_("Event messages are saved for this "
                                   "number of turns. A value of "
                                   "0 deactivates the event cache."),
                                NULL, NULL, NULL, GAME_MIN_EVENT_CACHE_TURNS,
                                GAME_MAX_EVENT_CACHE_TURNS,
                                GAME_DEFAULT_EVENT_CACHE_TURNS)

                            GEN_INT(
                                "ec_max_size",
                                game.server.event_cache.max_size, SSET_META,
                                SSET_INTERNAL, SSET_SITUATIONAL, ALLOW_NONE,
                                ALLOW_BASIC, N_("Size of the event cache"),
                                N_("This defines the maximal number of "
                                   "events in the event cache."),
                                NULL, NULL, NULL,
                                ...
                                GEN_BOOL("ec_chat",
                                         ...
                                         SSET_SITUATIONAL, ALLOW_NONE,
                                         ALLOW_BASIC,
                                         N_("Save chat messages in the "
                                            "event cache"),
                                         N_("If turned on, chat messages "
                                            "will be saved in the event "
                                            "cache."),
                                         NULL, NULL,
                                    ...
                                    GEN_BOOL(
                                        ...
                                        SSET_SITUATIONAL, ALLOW_NONE,
                                        ALLOW_BASIC,
                                        N_("Print turn and time for each "
                                           "cached event"),
                                        /* TRANS: Don't translate the text
                                           between single quotes. */
                                        N_("If turned on, all cached events "
                                           "will be marked by the turn "
                                           "and time of the event like '(T2 "
                                           "- 15:29:52)'."),
                                        NULL, NULL,
    ...
    GEN_STRING(
        ...
        GEN_BOOL("startcity", game.server.start_city, SSET_GAME_INIT,
            ...
            GEN_INT("dispersion", game.server.dispersion, SSET_GAME_INIT,
                    SSET_SOCIOLOGY, SSET_SITUATIONAL, ALLOW_NONE,
                    ALLOW_BASIC, N_("Area where initial units are located"),
                    N_("This is the radius within "
                       "which the initial units are dispersed."),
                    NULL, NULL, NULL, GAME_MIN_DISPERSION,
                    GAME_MAX_DISPERSION, GAME_DEFAULT_DISPERSION)

                GEN_INT("gold", game.info.gold, SSET_GAME_INIT,
                        SSET_ECONOMICS, SSET_VITAL, ALLOW_NONE, ALLOW_BASIC,
                        N_("Starting gold per player"),
                        N_("At the beginning of the game, each player is "
                           "given this "
                           "much gold."),
                        NULL, NULL, NULL, GAME_MIN_GOLD, GAME_MAX_GOLD,
                        GAME_DEFAULT_GOLD)
                    ...
                    GEN_INT("infrapoints", game.info.infrapoints,
                            ...
                            N_("At the beginning of the game, each player "
                               "is given this "
                               "many infrapoints."),
                            NULL, NULL, NULL, GAME_MIN_INFRA, GAME_MAX_INFRA,
                            GAME_DEFAULT_INFRA)

                        GEN_INT(
                            "techlevel", game.info.tech, SSET_GAME_INIT,
                            SSET_SCIENCE, SSET_VITAL, ALLOW_NONE,
                            ALLOW_BASIC,
                            N_("Number of initial techs per player"),
                            /* TRANS: The string between single quotes is a
                             * setting name and should not be translated. */
                            N_("At the beginning of the game, each player "
                               "is given this "
                               "many technologies. The technologies chosen "
                               "are random for "
                               "each player. Depending on the value of "
                               "tech_cost_style in "
                               "the ruleset, a big value for 'techlevel' "
                               "can make the next "
                               "techs really expensive."),
                            NULL, NULL, NULL, GAME_MIN_TECHLEVEL,
                            GAME_MAX_TECHLEVEL, GAME_DEFAULT_TECHLEVEL)

                            GEN_INT(
                                "sciencebox", game.info.sciencebox,
                                SSET_RULES_SCENARIO, SSET_SCIENCE,
                                SSET_SITUATIONAL, ALLOW_NONE, ALLOW_BASIC,
                                N_("Technology cost multiplier percentage"),
                                N_("This affects how quickly players can "
                                   "research new "
                                   "technology. All tech costs are "
                                   "multiplied by this amount "
                                   "(as a percentage). The base tech costs "
                                   "are determined by "
                                   "the ruleset or other game settings."),
                                NULL, NULL, NULL, GAME_MIN_SCIENCEBOX,
                                GAME_MAX_SCIENCEBOX, GAME_DEFAULT_SCIENCEBOX)

                                GEN_BOOL("multiresearch",
                                         game.server.multiresearch,
                                         SSET_RULES, SSET_SCIENCE, SSET_RARE,
                                         ALLOW_NONE, ALLOW_BASIC,
                                         N_("Allow researching multiple "
                                            "technologies"),
                                         N_("Allows switching to any "
                                            "technology without wasting old "
                                            "research. Bulbs are never "
                                            "transfered to new technology. "
                                            "Techpenalty options are "
                                            "inefective after enabling that "
                                            "option."),
                                         NULL, NULL,
                                    ...
                                    GEN_INT(
                                        "techpenalty",
                                        game.server.techpenalty, SSET_RULES,
                                        SSET_SCIENCE, SSET_RARE, ALLOW_NONE,
                                        ALLOW_BASIC,
                                        N_("Percentage penalty when "
                                           "changing tech"),
                                        N_("If you change your current "
                                           "research technology, and you "
                                           "have "
                                           "positive research points, you "
                                           "lose this percentage of those "
                                           "research points. This does not "
                                           "apply when you have just gained "
                                           "a technology this turn."),
                                        NULL, NULL, NULL,
                                        ...
                                        GEN_INT(
                                            ...
                                            SSET_RARE, ALLOW_NONE,
                                            ALLOW_BASIC,
                                            N_("Chance to lose a technology "
                                               "while receiving it"),
                                            N_("The chance that learning a "
                                               "technology by treaty or "
                                               "theft "
                                               "will fail."),
                                            NULL, NULL, NULL,
    ...
    GEN_INT("fulltradesize", game.info.fulltradesize, SSET_RULES,
            ...
            NULL, NULL, NULL, GAME_MIN_FULLTRADESIZE, GAME_MAX_FULLTRADESIZE,
            GAME_DEFAULT_FULLTRADESIZE)

        GEN_INT(
            "notradesize", game.info.notradesize, SSET_RULES, SSET_ECONOMICS,
            ...
            NULL, NULL, NULL, GAME_MIN_NOTRADESIZE, GAME_MAX_NOTRADESIZE,
            GAME_DEFAULT_NOTRADESIZE)

            GEN_INT(
                "tradeworldrelpct", game.info.trade_world_rel_pct,
                SSET_RULES, SSET_ECONOMICS, SSET_RARE, ALLOW_NONE,
                ALLOW_BASIC,
                N_("How largely trade distance is relative to world size"),
                /* TRANS: The strings between single quotes are setting names
                 * and shouldn't be translated. */
                N_("When determining trade between cities, the distance "
                   "factor "
                   "can be partly or fully relative to world size. This "
                   "setting "
                   "determines how big percentage of the bonus calculation "
                   "is "
                   "relative to world size, and how much only absolute "
                   "distance "
                   "matters."),
                NULL, NULL, NULL, GAME_MIN_TRADEWORLDRELPCT,
                GAME_MAX_TRADEWORLDRELPCT, GAME_DEFAULT_TRADEWORLDRELPCT)

                GEN_INT("citymindist", game.info.citymindist, SSET_RULES,
                        SSET_SOCIOLOGY, SSET_SITUATIONAL, ALLOW_NONE,
                        ALLOW_BASIC, N_("Minimum distance between cities"),
                        N_("When a player attempts to found a new city, it "
                           "is prevented "
                           "if the distance from any existing city is less "
                           "than this "
                           "setting. For example, when this setting is 3, "
                           "there must be "
                           "at least two clear tiles in any direction "
                           "between all existing "
                           "cities and the new city site. A value of 1 "
                           "removes any such "
                           "restriction on city placement."),
                        NULL, NULL, NULL, GAME_MIN_CITYMINDIST,
                    ...
                    GEN_BOOL("trading_tech", game.info.trading_tech,
                             ...
                             N_("If turned off, trading technologies in the "
                                "diplomacy dialog "
                                "is not allowed."),
                             NULL, NULL, GAME_DEFAULT_TRADING_TECH)

                        GEN_BOOL("trading_gold", game.info.trading_gold,
                                 SSET_RULES, SSET_SOCIOLOGY, SSET_RARE,
                                 ALLOW_NONE, ALLOW_BASIC, N_("Gold trading"),
                                 N_("If turned off, trading gold in the "
                                    "diplomacy dialog "
                                    "is not allowed."),
                                 NULL, NULL, GAME_DEFAULT_TRADING_GOLD)

                            GEN_BOOL("trading_city", game.info.trading_city,
                                     SSET_RULES, SSET_SOCIOLOGY, SSET_RARE,
                                     ALLOW_NONE, ALLOW_BASIC,
                                     N_("City trading"),
                                     N_("If turned off, trading cities in "
                                        "the diplomacy dialog "
                                        "is not allowed."),
                                     NULL, NULL, GAME_DEFAULT_TRADING_CITY)

                                GEN_ENUM(
                                    "caravan_bonus_style",
                                    game.info.caravan_bonus_style,
                                    SSET_RULES, SSET_ECONOMICS, SSET_RARE,
                                    ALLOW_NONE, ALLOW_BASIC,
                                    N_("Caravan bonus style"),
                                    N_("The formula for the bonus when a "
                                       "caravan enters a city. "
                                       "CLASSIC bonuses are proportional to "
                                       "distance and trade "
                                       "of source and destination with "
                                       "multipliers for overseas and "
                                       "international destinations. "
                                       "LOGARITHMIC bonuses are "
                                       "proportional to log^2(distance + "
                                       "trade)."),
                                    ...
                                    GEN_ENUM(
                                        "trade_revenue_style",
                                        game.info.trade_revenue_style,
                                        SSET_RULES, SSET_ECONOMICS,
                                        SSET_RARE, ALLOW_NONE, ALLOW_BASIC,
                                        N_("Trade revenue style"),
                                        N_("The formula for the trade a "
                                           "city receives from a "
                                           "traderoute. "
                                           "CLASSIC revenues depend on "
                                           "distance and trade with "
                                           "multipliers for overseas and "
                                        ...
                                        GEN_INT(
                                            ...
                                            SSET_RARE, ALLOW_NONE,
                                            ALLOW_BASIC,
                                            N_("Minimum distance for trade "
                                               "routes"),
                                            N_("In order for two cities in "
                                               "the same civilization to "
                                               "establish "
                                               "a trade route, they must be "
                                               "at least this far apart on "
                                               "the "
                                               "map. For square grids, the "
                                            ...
                                            GEN_INT(
                                                ...
                                                SSET_RULES, SSET_SOCIOLOGY,
                                                SSET_SITUATIONAL, ALLOW_NONE,
                                                ALLOW_BASIC,
                                                N_("Number of turns between "
                                                   "rapture effect"),
                                                N_("Sets the number of "
                                                   "turns between rapture "
                                                   "growth of a city. "
                                                   "If set to n a city will "
                                                ...
                                                GEN_INT(
                                                    ...
                                                    SSET_RULES_FLEXIBLE,
                                                    SSET_SOCIOLOGY,
                                                    SSET_VITAL, ALLOW_NONE,
                                                    ALLOW_BASIC,
                                                    N_("Frequency of "
                                                       "disasters"),
                                                    N_("Affects how often "
                                                       "random disasters "
                                                       "happen to cities, "
                                                       "if any are defined "
                                                       "by the ruleset. The "
    ...
    GEN_ENUM("barbarians", game.server.barbarianrate, SSET_RULES_FLEXIBLE,
        ...
        GEN_INT("onsetbarbs", game.server.onsetbarbarian,
                SSET_RULES_FLEXIBLE, SSET_MILITARY, SSET_VITAL, ALLOW_NONE,
                ALLOW_BASIC, N_("Barbarian onset turn"),
                N_("Barbarians will not appear before this turn."), NULL,
                NULL, NULL, GAME_MIN_ONSETBARBARIAN, GAME_MAX_ONSETBARBARIAN,
                GAME_DEFAULT_ONSETBARBARIAN)

            GEN_ENUM("revolentype", game.info.revolentype, SSET_RULES,
                     SSET_SOCIOLOGY, SSET_RARE, ALLOW_NONE, ALLOW_BASIC,
                     N_("Way to determine revolution length"),
                     N_("Which method is used in determining how long "
                        "period of anarchy "
                        "lasts when changing government. The actual value "
                        "is set with "
                        "'revolen' setting. The 'quickening' methods depend "
                        "on how "
                        "many times any player has changed to this type of "
                        "government "
                        "before, so it becomes easier to establish a new "
                        "system of "
                        "government if it has been done before."),
                     NULL, NULL, NULL, revolentype_name,
                     GAME_DEFAULT_REVOLENTYPE)

                GEN_INT("revolen", game.server.revolution_length,
                        SSET_RULES_FLEXIBLE, SSET_SOCIOLOGY, SSET_RARE,
                        ALLOW_NONE, ALLOW_BASIC, N_("Length of revolution"),
                        N_("When changing governments, a period of anarchy "
                           "will occur. "
                           "Value of this setting, used the way "
                           "'revolentype' setting "
                           "dictates, defines the length of the anarchy."),
                        NULL, NULL, NULL, GAME_MIN_REVOLUTION_LENGTH,
                        GAME_MAX_REVOLUTION_LENGTH,
                        GAME_DEFAULT_REVOLUTION_LENGTH)

                    GEN_BOOL("fogofwar", game.info.fogofwar, SSET_RULES,
                             SSET_MILITARY, SSET_RARE, ALLOW_NONE,
                             ALLOW_BASIC, N_("Whether to enable fog of war"),
                             N_("If this is enabled, only those units and "
                                "cities within "
                                "the vision range of your own units and "
                                "cities will be "
                                "revealed to you. You will not see new "
                                "cities or terrain "
                                "changes in tiles not observed."),
                             NULL, NULL, GAME_DEFAULT_FOGOFWAR)

                        GEN_BOOL("foggedborders", game.server.foggedborders,
                                 SSET_RULES, SSET_MILITARY, SSET_RARE,
                                 ALLOW_NONE, ALLOW_BASIC,
                                 N_("Whether fog of war applies to border "
                                    "changes"),
                                 N_("If this setting is enabled, players "
                                    "will not be able "
                                    "to see changes in tile ownership if "
                                    "they do not have "
                                    "direct sight of the affected tiles. "
                                    "Otherwise, players "
                                    "can see any or all changes to borders "
                                    "as long as they "
                            ...
                            GEN_BITWISE(
                                "airliftingstyle",
                                game.info.airlifting_style,
                                SSET_RULES_FLEXIBLE, SSET_MILITARY,
                                SSET_SITUATIONAL, ALLOW_NONE, ALLOW_BASIC,
                                N_("Airlifting style"),
                                /* TRANS: The strings between double quotes
                                 * are also translated separately (they must
                                 * match!). The strings between parenthesis
                                 * and in uppercase must not be translated.
                                 */
                                N_("This setting affects airlifting units "
                                   "between cities. It "
                                   "can be a set of the following values:\n"
                                   "- \"Allows units to be airlifted from "
                                   "allied cities\" "
                                   "(FROM_ALLIES).\n"
                                   "- \"Allows units to be airlifted to "
                                   "allied cities\" "
                                   "(TO_ALLIES).\n"
                                   "- \"Unlimited units from source city\" "
                                   "(SRC_UNLIMITED): "
                                   "note that airlifting from a city "
                                   "doesn't reduce the "
                                   "airlifted counter, but still needs "
                                   "airlift capacity of "
                                   "at least 1.\n"
                                   "- \"Unlimited units to destination "
                                   "city\" "
                                   "(DEST_UNLIMITED): note that airlifting "
                                   "to a city doesn't "
                                   "reduce the airlifted counter, and "
                                   "doesn't need any "
                                   "airlift capacity."),
                                NULL, NULL, airliftingstyle_name,
                                GAME_DEFAULT_AIRLIFTINGSTYLE)

                                GEN_INT(
                                    "diplchance", game.server.diplchance,
                                    SSET_RULES_FLEXIBLE, SSET_MILITARY,
                                    SSET_SITUATIONAL, ALLOW_NONE,
                                    ALLOW_BASIC,
                                    N_("Base chance for diplomats and spies "
                                       "to succeed"),
                                    N_("The base chance of a spy returning "
                                       "from a successful mission and "
                                       "the base chance of success for "
                                       "diplomats and spies."),
                                    NULL, NULL, NULL, GAME_MIN_DIPLCHANCE,
                                    GAME_MAX_DIPLCHANCE,
                                    GAME_DEFAULT_DIPLCHANCE)

                                    GEN_BITWISE(
                                        "victories",
                                        game.info.victory_conditions,
                                        SSET_RULES_FLEXIBLE, SSET_INTERNAL,
                                        SSET_VITAL, ALLOW_NONE, ALLOW_BASIC,
                                        N_("What kinds of victories are "
                                           "possible"),
                                        /* TRANS: The strings between double
                                         * quotes are also translated
                                         * separately (they must match!). The
                                         ...
                                         * parentheses and in uppercase must
                                         * stay as untranslated. */
                                        N_("This setting controls how game "
                                           "can be won. One can always "
                                           "win by conquering entire "
                                           "planet, but other victory "
                                           "conditions "
                                           "can be enabled or disabled:\n"
                                           "- \"Spacerace\" (SPACERACE): "
                                           "Spaceship is built and travels "
                                           "to "
                                           "Alpha Centauri.\n"
                                           "- \"Allied\" (ALLIED): After "
                                           "defeating enemies, all "
                                           "remaining "
                                           "players are allied.\n"
                                           "- \"Culture\" (CULTURE): Player "
                                           "meets ruleset defined cultural "
                                           "domination criteria.\n"),
                                        NULL, NULL, victory_conditions_name,
                                        ...
                                        GEN_BOOL(
                                            ...
                                            SSET_RULES_FLEXIBLE,
                                            SSET_SCIENCE, SSET_VITAL,
                                            ALLOW_NONE, ALLOW_BASIC,
                                            N_("Should the game end if the "
                                               "spaceship arrives?"),
                                            N_("If this option is turned "
                                               "on, the game will end with "
                                               "the "
                                               "arrival of a spaceship at "
                                               "Alpha Centauri."),
                                            NULL, NULL,
                                            ...
                                            GEN_INT(
                                                ...
                                                SSET_SCIENCE, SSET_VITAL,
                                                ALLOW_NONE, ALLOW_BASIC,
                                                N_("Percentage to multiply "
                                                   "spaceship travel time "
                                                   "by"),
                                                N_("This percentage is "
                                                   "multiplied onto the "
                                                   "time it will take for "
                                                   "a spaceship to arrive "
                                                   "at Alpha Centauri."),
                                                NULL, NULL, NULL,
                                                GAME_MIN_SPACESHIP_TRAVEL_TIME,
                                                GAME_MAX_SPACESHIP_TRAVEL_TIME,
    ...
    GEN_STRING(
        ...
        GEN_BOOL("autotoggle", game.server.auto_ai_toggle, SSET_META,
            ...
            GEN_INT("endturn", game.server.end_turn, SSET_META,
                    SSET_SOCIOLOGY, SSET_VITAL, ALLOW_NONE, ALLOW_BASIC,
                    N_("Turn the game ends"),
                    N_("The game will end at the end of the given turn."),
                    NULL, endturn_callback, NULL, GAME_MIN_END_TURN,
                    GAME_MAX_END_TURN, GAME_DEFAULT_END_TURN)

                GEN_BITWISE(
                    "revealmap", game.server.revealmap, SSET_GAME_INIT,
                     ...
                     * between single quotes are setting names and shouldn't
                     * be translated. The strings between parentheses and in
                     * uppercase must not be translated. */
                    N_("If \"Reveal map at game start\" (START) is set, the "
                       "initial state of the entire map will be known to "
                       "all "
                       "players from the start of the game, although it may "
                       "still be fogged (depending on the 'fogofwar' "
                       "setting). "
                       "If \"Unfog map for dead players\" (DEAD) is set, "
                       "dead "
                       "players can see the entire map, if they are alone "
                       "in "
                       "their team."),
                    NULL, NULL, revealmap_name, GAME_DEFAULT_REVEALMAP)

                    GEN_INT("timeout", game.info.timeout, SSET_META,
                            SSET_INTERNAL, SSET_VITAL, ALLOW_NONE,
                            ALLOW_BASIC, N_("Maximum seconds per turn"),
                            /* TRANS: \"Turn Done\" refers to the client
                             * button; it is also translated separately, the
                             * translation should be the same.
                             * \"timeoutincrease\" is a command name and must
                             * not to be translated. */
                            N_("If all players have not hit \"Turn Done\" "
                               "before this "
                               "time is up, then the turn ends "
                               "automatically. Zero "
                               "means there is no timeout. In servers "
                               "compiled with "
                               "debugging, a timeout of -1 sets the "
                               "autogame test mode. "
                               "Only connections with hack level access may "
                               "set the "
                               "timeout to fewer than 30 seconds. Use this "
                               "with the "
                               "command \"timeoutincrease\" to have a "
                               "dynamic timer. "
                               "The first turn is treated as a special case "
                               "and is controlled "
                        ...
                        GEN_INT(
                            "first_timeout", game.info.first_timeout,
                            SSET_META, SSET_INTERNAL, SSET_VITAL, ALLOW_NONE,
                            ALLOW_BASIC, N_("First turn timeout"),
                            /* TRANS: The strings between single quotes are
                             * setting names and should not be translated. */
                            N_("If greater than 0, T1 will last for "
                               "'first_timeout' seconds.\n"
                               "If set to 0, T1 will not have a timeout.\n"
                               "If set to -1, the special treatment of T1 "
                               "will be disabled.\n"
                               "See also 'timeout'."),
                            NULL, first_timeout_callback,
                            first_timeout_action, GAME_MIN_FIRST_TIMEOUT,
                            GAME_MAX_FIRST_TIMEOUT,
                            GAME_DEFAULT_FIRST_TIMEOUT)

                            GEN_INT("timeaddenemymove",
                                    game.server.timeoutaddenemymove,
                                    SSET_META, SSET_INTERNAL, SSET_VITAL,
                                    ALLOW_NONE, ALLOW_BASIC,
                                    N_("Timeout at least n seconds when "
                                       "enemy moved"),
                                    N_("Any time a unit moves while in "
                                       "sight of an enemy player, "
                                       "the remaining timeout is increased "
                                       "to this value."),
                                    NULL, NULL, NULL, 0, GAME_MAX_TIMEOUT,
                                    GAME_DEFAULT_TIMEOUTADDEMOVE)

                                GEN_INT("unitwaittime",
                                        game.server.unitwaittime,
                                        SSET_RULES_FLEXIBLE, SSET_INTERNAL,
                                        SSET_VITAL, ALLOW_NONE, ALLOW_BASIC,
                                        N_("Minimum time between unit "
                                           "actions over turn change"),
                                        /* TRANS: The string between single
                                         * quotes is a setting name and
                                         * should not be translated. */
                                        N_("This setting gives the minimum "
                                           "amount of time in seconds "
                                           "between unit moves and other "
                                           "significant actions (such as "
                                           "building cities) after a turn "
                                           "change occurs. For example, "
                                           "if this setting is set to 20 "
                                           "and a unit moves 5 seconds "
                                           "before the turn change, it will "
                                           "not be able to move or act "
                                           "in the next turn for at least "
                                           "15 seconds. This value is "
                                           "limited to a maximum value of "
                                           "2/3 'timeout'."),
                                        NULL, unitwaittime_callback, NULL,
    ...
    GEN_ENUM("phasemode", game.server.phase_mode_stored, SSET_META,
             ...
             phasemode_help, NULL, NULL, phasemode_name,
             GAME_DEFAULT_PHASE_MODE)

        GEN_INT(
            "nettimeout", game.server.tcptimeout, SSET_META, SSET_NETWORK,
            SSET_RARE, ALLOW_NONE, ALLOW_BASIC,
            ...
            NULL, NULL, NULL, GAME_MIN_TCPTIMEOUT, GAME_MAX_TCPTIMEOUT,
            GAME_DEFAULT_TCPTIMEOUT)

            GEN_INT(
                "netwait", game.server.netwait, SSET_META, SSET_NETWORK,
                SSET_RARE, ALLOW_NONE, ALLOW_BASIC,
                ...
                N_("The server will wait for up to the value of this "
                   ...
                   "wait at all."),
                NULL, NULL, NULL, GAME_MIN_NETWAIT, GAME_MAX_NETWAIT,
                GAME_DEFAULT_NETWAIT)

                GEN_INT("pingtime", game.server.pingtime, SSET_META,
                        SSET_NETWORK, SSET_RARE, ALLOW_NONE, ALLOW_BASIC,
                        N_("Seconds between PINGs"),
                        N_("The server will poll the clients with a PING "
                           "request "
                           "each time this period elapses."),
                        NULL, NULL, NULL, GAME_MIN_PINGTIME,
                        GAME_MAX_PINGTIME, GAME_DEFAULT_PINGTIME)

                    GEN_INT("pingtimeout", game.server.pingtimeout,
                            SSET_META, SSET_NETWORK, SSET_RARE, ALLOW_NONE,
                            ALLOW_BASIC, N_("Time to cut a client"),
                            N_("If a client doesn't reply to a PING in this "
                               "time the "
                               "client is disconnected."),
                            NULL, NULL, NULL, GAME_MIN_PINGTIMEOUT,
                        ...
                        GEN_BOOL("turnblock", game.server.turnblock,
                                 ...
                                 N_("If this is turned on, the game turn is "
                                    "not advanced "
                                    "until all players have finished their "
                                    "turn, including "
                            ...
                            GEN_BOOL("fixedlength", game.server.fixedlength,
                                     ...
                                     /* TRANS: \"Turn Done\" refers to the
                                      * client button; it is also
                                      * translated separately, the
                                      * translation should be the same. */
                                     N_("If this is turned on the game turn "
                                        "will not advance "
                                ...
                                GEN_STRING(
                                    ...
                                    /* TRANS: The strings between double
                                     * quotes should be translated. */
                                    N_("This should be a string of "
                                       "characters, each of which "
                                       "specifies the inclusion of a line "
                                       "of information "
                                       ...
                                       "characters control whether "
                                       "or not certain columns are "
                                       "displayed in the report:\n"
                                       "    q = display \"quantity\" "
                                       "column\n"
                                       "    r = display \"rank\" column\n"
                                       "    b = display \"best nation\" "
                                       "column\n"
                                       "The order of characters is not "
                                       "significant, but "
                                       "their capitalization is."),
                                    demography_callback, NULL,
                                    GAME_DEFAULT_DEMOGRAPHY)

                                    GEN_INT(
                                        "saveturns", game.server.save_nturns,
                                        SSET_META, SSET_INTERNAL, SSET_VITAL,
                                        ALLOW_HACK, ALLOW_HACK,
                                        N_("Turns per auto-save"),
                                        /* TRANS: The string between double
                                         * quotes is also translated
                                         * separately (it must match!). The
                                         * string between single
                                         * quotes is a setting name and
                                         * shouldn't be translated. */
                                        N_("How many turns elapse between "
                                           "automatic game saves. This "
                                           "setting only has an effect when "
                                           "the 'autosaves' setting "
                                           "includes \"New turn\"."),
                                        NULL, NULL, NULL, GAME_MIN_SAVETURNS,
                                        GAME_MAX_SAVETURNS,
                                        GAME_DEFAULT_SAVETURNS)

                                        GEN_INT(
                                            "savefrequency",
                                            game.server.save_frequency,
                                            SSET_META, SSET_INTERNAL,
                                            SSET_VITAL, ALLOW_HACK,
                                            ALLOW_HACK,
                                            N_("Minutes per auto-save"),
                                            /* TRANS: The string between
                                             * double quotes is also
                                             * translated separately (it must
                                             * match!). The string between
                                             * single quotes is a setting
                                             * name and shouldn't be
                                             * translated. */
                                            N_("How many minutes elapse "
                                               "between automatic game "
                                               "saves. "
                                               "Unlike other save types, "
                                               "this save is only meant as "
                                               "backup "
                                               "for computer memory, and it "
                                               "always uses the same name, "
                                               "older "
                                               "saves are not kept. This "
                                            ...
                                            GEN_BITWISE(
                                                "autosaves",
                                                game.server.autosaves,
                                                SSET_META, SSET_INTERNAL,
                                                SSET_VITAL, ALLOW_HACK,
                                                ALLOW_HACK,
                                                N_("Which savegames are "
                                                   "generated "
                                                   "automatically"),
                                                /* TRANS: The strings between
                                                 * double quotes are also
                                                 * translated separately
                                                 * (they must match!). The
                                                 * strings between single
                                                 * quotes are setting names
                                                 * and shouldn't be
                                                 * translated. The strings
                                                 * between parentheses and in
                                                 * uppercase must stay as
                                                 * untranslated. */
                                                N_("This setting controls "
                                                   "which autosave types "
                                                   "get generated:\n"
                                                   "- \"New turn\" (TURN): "
                                                   "Save when turn begins, "
                                                   "once every "
                                                   "'saveturns' turns.\n"
                                                   "- \"Game over\" "
                                                   "(GAMEOVER): Final save "
                                                ...
                                                GEN_BOOL(
                                                    ...
                                                    /* TRANS: The string
                                                     * between single quotes
                                                     * is a setting name and
                                                     * should not be
                                                     * translated. */
                                                    N_("If this is turned "
                                                       "in, compressing and "
                                                       "saving the actual "
                                                       "file containing the "
                                                       "game situation "
