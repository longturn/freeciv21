...
bool adv_data_phase_init(struct player *pplayer, bool is_new_phase)
{
  ...
  adv->threats.continent = static_cast<bool*>(fc_calloc(adv->num_continents + 1, sizeof(bool)));
  adv->threats.invasions = FALSE;
  adv->threats.nuclear   = 0; /* none */
  adv->threats.ocean     = static_cast<bool*>(fc_calloc(adv->num_oceans + 1, sizeof(bool)));
  ...
  adv->explore.continent = static_cast<bool*>(fc_calloc(adv->num_continents + 1, sizeof(bool)));
  adv->explore.ocean = static_cast<bool*>(fc_calloc(adv->num_oceans + 1, sizeof(bool)));
  ...
  adv->stats.cities = static_cast<int*>(fc_calloc(adv->num_continents + 1, sizeof(int)));
  adv->stats.ocean_cities = static_cast<int*>(fc_calloc(adv->num_oceans + 1, sizeof(int)));
...
void adv_data_init(struct player *pplayer)
{
  ...
  if (pplayer->server.adv == NULL) {
    pplayer->server.adv = static_cast<adv_data*>(fc_calloc(1, sizeof(*pplayer->server.adv)));
  }
  adv = pplayer->server.adv;

  adv->government_want = NULL;

  adv->dipl.adv_dipl_slots = static_cast<adv_dipl**>(fc_calloc(player_slot_count(),
...
void adv_data_default(struct player *pplayer)
{
  ...
  adv->govt_reeval = 0;
  adv->government_want = static_cast<adv_want*>(fc_realloc(adv->government_want,
                                   (government_count() + 1)
