...
void smooth_int_map(int *int_map, bool zeroes_at_edges)
{
  ...
  int *alt_int_map = static_cast<int*>(fc_calloc(MAP_INDEX_SIZE, sizeof(*alt_int_map)));
...
static void recalculate_lake_surrounders(void)
{
  ...
  lake_surrounders = static_cast<Continent_id*>(fc_realloc(lake_surrounders, size));
...
void assign_continent_numbers(void)
{
  ...
  whole_map_iterate(&(wld.map), ptile) {
    ...
    if (terrain_type_terrain_class(pterrain) != TC_OCEAN) {
      ...
      continent_sizes = static_cast<int*>(fc_realloc(continent_sizes,
      ...
      wld.map.num_oceans++;
      ocean_sizes = static_cast<int*>(fc_realloc(ocean_sizes,
