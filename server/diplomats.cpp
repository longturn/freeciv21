                       ...
                       struct unit *pvictim, const struct action *paction)
{
  ...
  if (!diplomat_infiltrate_tile(pplayer, uplayer, paction, pdiplomat,
                                pvictim, unit_tile(pvictim), NULL)) {
    return FALSE;
  }
                ...
                struct tile *tgt_tile, const struct action *paction)
{
  ...
  diplomat_infiltrate_tile(act_player, NULL, paction, act_unit, NULL,
                           tgt_tile, &tgt_player);
                            ...
                            struct player *inc_player, int revolt_gold)
{
  ...
  if (fc_rand(100) < game.server.incite_gold_loss_chance) {
    ...
    if (fc_rand(100) < game.server.incite_gold_capt_chance) {
      ...
      notify_player(inc_player, NULL, E_ENEMY_DIPLOMAT_FAILED, ftc_server,
                         ...
                         struct city *tgt_city, const struct action *paction)
{
  ...
  normal_tile_prob =
      ...
      + get_target_bonus_effects(NULL, act_player, tgt_player,
                                  ...
                                  * transferred. */
                                 NULL, act_unit, unit_type_get(act_unit),
                                 NULL, NULL, paction, EFT_MAPS_STOLEN_PCT);
                                         ...
                                         struct tile *pdefender_tile)
{
  ...
  chance -= chance
            * get_target_bonus_effects(NULL, tile_owner(pdefender_tile),
                                       NULL, tile_city(pdefender_tile), NULL,
                            ...
                            const struct action *paction)
{
  ...
  return diplomat_escape_full(pplayer, pdiplomat, pcity != NULL, ptile,
                              vlink, paction);
}
