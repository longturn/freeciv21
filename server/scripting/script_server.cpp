...
static void script_server_signals_create(void)
{
  ...
  luascript_signal_create(fcl_main, "turn_begin", 2, API_TYPE_INT,
                          API_TYPE_INT);

  /* Deprecated form of the 'turn_begin' signal that counts real turns
   * starting from 0. */
  depr = luascript_signal_create(fcl_main, "turn_started", 2, API_TYPE_INT,
                                 API_TYPE_INT);
  ...
  luascript_signal_create(fcl_main, "city_size_change", 3, API_TYPE_CITY,
                          API_TYPE_INT, API_TYPE_STRING);

  /* Deprecated form of the 'city_size_change' signal for the case of growth.
   */
  depr = luascript_signal_create(fcl_main, "city_growth", 2, API_TYPE_CITY,
                                 API_TYPE_INT);
  ...
  luascript_signal_create(fcl_main, "unit_cant_be_built", 3,
                          API_TYPE_UNIT_TYPE, API_TYPE_CITY,
                          API_TYPE_STRING);
   ...
   */
  luascript_signal_create(fcl_main, "building_lost", 4, API_TYPE_CITY,
                          API_TYPE_BUILDING_TYPE, API_TYPE_STRING,
                          API_TYPE_UNIT);
   ...
   * conquest. */
  depr = luascript_signal_create(fcl_main, "city_lost", 3, API_TYPE_CITY,
                                 API_TYPE_PLAYER, API_TYPE_PLAYER);
  deprecate_signal(depr, "city_lost", "city_transferred", "2.6");

  luascript_signal_create(fcl_main, "hut_enter", 2, API_TYPE_UNIT,
                          API_TYPE_STRING);
  luascript_signal_create(fcl_main, "hut_frighten", 2, API_TYPE_UNIT,
                          API_TYPE_STRING);

  luascript_signal_create(fcl_main, "unit_lost", 3, API_TYPE_UNIT,
                          API_TYPE_PLAYER, API_TYPE_STRING);
   ...
   * 'had_internal_effct' support. */
  depr = luascript_signal_create(fcl_main, "disaster", 2, API_TYPE_DISASTER,
                                 API_TYPE_CITY);
  ...
  luascript_signal_create(fcl_main, "action_started_unit_unit", 3,
                          API_TYPE_ACTION, API_TYPE_UNIT, API_TYPE_UNIT);

  luascript_signal_create(fcl_main, "action_started_unit_units", 3,
                          API_TYPE_ACTION, API_TYPE_UNIT, API_TYPE_TILE);

  luascript_signal_create(fcl_main, "action_started_unit_city", 3,
                          API_TYPE_ACTION, API_TYPE_UNIT, API_TYPE_CITY);
