...
SERVER_SIGNAL(tech_researched, advance *, player *, const char *)
                         ...
                         struct advance *tech, const char *reason)
{
  ...
  if (originating_plr) {
    ...
    server_signals::tech_researched(tech, originating_plr, reason);
  }
  ...
  research_players_iterate(presearch, member)
  {
    if (member != originating_plr) {
      server_signals::tech_researched(tech, member, reason);
    }
  }
...
void do_tech_parasite_effect(struct player *pplayer)
{
  ...
  {
    server_signals::tech_researched(advance_by_number(tech), member,
                                    "stolen");
  }
  research_players_iterate_end;
}
