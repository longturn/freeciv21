...
struct genhash *genhash_new_full(
    ...
    genhash_free_fn_t data_free_func) fc__warn_unused_result;
...
struct genhash *genhash_new_nentries_full(
    genhash_val_fn_t key_val_func, genhash_comp_fn_t key_comp_func,
    genhash_copy_fn_t key_copy_func, genhash_free_fn_t key_free_func,
...
struct genhash *
genhash_copy(const struct genhash *pgenhash) fc__warn_unused_result;
