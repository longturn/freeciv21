...
-- SPDX-FileCopyrightText: Ryu, Gwang <http://www.gpgstudy.com/gpgiki/LuaUnit>
...
----------------------------------------------------------------
    ...
    function M.LuaUnit:execOneFunction(className, methodName, classInstance, methodInstance)
        ...
        dbg('execOneFunction() className=' .. prettystr(classname) ..
            ' methodName=' .. prettystr(methodName) ..
            ' classInstance=' .. prettystr(classInstance) .. 
            ' methodInstance=' .. prettystr(methodInstance))
