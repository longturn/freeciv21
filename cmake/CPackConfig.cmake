...
if(APPLE)
  ...
  set(CPACK_PACKAGE_FILE_NAME "${CPACK_PACKAGE_NAME}-${FC21_REV_TAG}-${CPACK_SYSTEM_NAME}")
  set(CPACK_COMPONENTS_GROUPING ALL_COMPONENTS_IN_ONE)
  set(CPACK_DMG_VOLUME_NAME "Freeciv21")
  set(CPACK_BUNDLE_NAME "Freeciv21")
  set(CPACK_BUNDLE_PLIST "${CMAKE_SOURCE_DIR}/dist/Info.plist")
  set(CPACK_BUNDLE_ICON "${CMAKE_SOURCE_DIR}/dist/client.ico")
