 ...
 **************************************************************************/
struct ai_type *texai_get_self(void) { return self; }
...
{
  TEXAI_AIT;
  TEXAI_DFUNC(dai_incident, type, scope, paction, receiver, violator,
              victim);
}
 ...
 **************************************************************************/
const char *fc_ai_tex_capstr(void) { return FC_AI_MOD_CAPSTR; }
