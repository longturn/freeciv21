...
const char **gfx_fileextensions(void)
{
  ...
  static const char *ext[] = {"png", /* png should be the default. */
                              /* ...etc... */
                              NULL};
 ...
 ****************************************************************************/
struct sprite *gui_crop_sprite(struct sprite *source, int x, int y,
 ...
 ****************************************************************************/
void gui_get_sprite_dimensions(struct sprite *sprite, int *width,
                               int *height)
{
  /* PORTME */
#if 0
 ...
 ****************************************************************************/
void gui_free_sprite(struct sprite *s) { /* PORTME */ }
