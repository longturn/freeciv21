...
/************************************************************************/ /**
   ...
   itself.
 ****************************************************************************/
void gui_canvas_free(struct canvas *store) { /* PORTME */ }

/************************************************************************/ /**
   Set canvas zoom for future drawing operations.
 ****************************************************************************/
void gui_canvas_set_zoom(struct canvas *store, float zoom) { /* PORTME */ }
 ...
 ****************************************************************************/
void gui_canvas_copy(struct canvas *dest, struct canvas *src, int src_x,
 ...
 ****************************************************************************/
void gui_canvas_put_sprite(struct canvas *pcanvas, int canvas_x,
 ...
 ****************************************************************************/
void gui_canvas_put_sprite_full(struct canvas *pcanvas, int canvas_x,
...
/************************************************************************/ /**
   ...
   fog.
 ****************************************************************************/
void gui_canvas_put_sprite_fogged(struct canvas *pcanvas, int canvas_x,
 ...
 ****************************************************************************/
void gui_get_text_size(int *width, int *height, enum client_font font,
                       const char *text)
{
  /* PORTME */
  if (width) {
