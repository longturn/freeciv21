...
static std::vector<fc_shortcut> default_shortcuts()
{
  return {
      ...
      {SC_UNSENTRY_TILE, fc_shortcut::keyboard,
       QKeyCombination(Qt::ShiftModifier | Qt::ControlModifier, Qt::Key_D),
       Qt::AllButtons, Qt::NoModifier, _("Unsentry All On Tile")},
      ...
      {SC_IFACE_LOCK, fc_shortcut::keyboard,
       ...
       Qt::AllButtons, Qt::NoModifier, _("Lock/unlock interface")},
      ...
      {SC_RELOAD_THEME, fc_shortcut::keyboard,
       QKeyCombination(Qt::ControlModifier | Qt::ShiftModifier, Qt::Key_F5),
       Qt::AllButtons, Qt::NoModifier, _("Reload theme")},
      {SC_RELOAD_TILESET, fc_shortcut::keyboard,
       QKeyCombination(Qt::ControlModifier | Qt::ShiftModifier, Qt::Key_F6),
       Qt::AllButtons, Qt::NoModifier, _("Reload tileset")},
      ...
      {SC_LOAD_LUA, fc_shortcut::keyboard,
       ...
       Qt::AllButtons, Qt::NoModifier, _("Load Lua script")},
      {SC_RELOAD_LUA, fc_shortcut::keyboard,
       QKeyCombination(Qt::ControlModifier | Qt::ShiftModifier, Qt::Key_K),
       Qt::AllButtons, Qt::NoModifier, _("Load last loaded Lua script")},
      ...
      {SC_MAP_EDITOR, fc_shortcut::keyboard,
       QKeyCombination(Qt::ShiftModifier | Qt::ControlModifier, Qt::Key_E),
