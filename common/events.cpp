...
static struct {
  ...
  enum event_type event;
    ...
    GEN_EV(E_WELCOME, E_S_XYZZY, N_("Welcome message")),
    GEN_EV(E_LOG_INFO, E_S_XYZZY, N_("Information")),
    GEN_EV(E_LOG_ERROR, E_S_XYZZY, N_("Error messages")),
    GEN_EV(E_LOG_FATAL, E_S_XYZZY, N_("Fatal error messages")),
