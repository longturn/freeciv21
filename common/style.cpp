...
struct music_style *player_music_style(struct player *plr)
{
  ...
  {
    if (are_reqs_active(plr, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                        NULL, &pms->reqs, RPT_CERTAIN)) {
      best = pms;
    }
  }
  music_styles_iterate_end;
...
int city_style(struct city *pcity)
{
  ...
  for (i = game.control.styles_count - 1; i >= 0; i--) {
    if (are_reqs_active(plr, NULL, pcity, NULL, city_tile(pcity), NULL, NULL,
